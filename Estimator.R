...
# these with the underline are scaler vector, no longer vectors of multiple variable names
Q_ <- paste(Q,collapse="+")
C_ <- paste(C,collapse="+")
L_ <- paste(L,collapse="+")

# generate formulas needed according to the presence or absence of Q, L_, and C.
if (Q_!="" & L_!="" & C_!="") {
